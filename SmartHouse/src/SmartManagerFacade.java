...
public class SmartManagerFacade {
    ...
    public void changeSupplier(String smarthome, int supplier){
        ...
        changedsupplier.put(clientSupplier(smarthome), new EnergySupplier(newclients, es.getInvoices(), es.getBasePriceRate(), es.getTax()));
        ...
        changedsupplier.put(supplier, new EnergySupplier(newclients2, esNewClient.getInvoices(), esNewClient.getBasePriceRate(), esNewClient.getTax()));
    ...
    public void changeSupplierTax(int supplier, float tax){
        ...
        changedsupplier.put(supplier, new EnergySupplier(es.getClients(), es.getInvoices(), es.getBasePriceRate(), tax));
    }

    public void changeSupplierBaseRate(int supplier, float baseRate){
        EnergySupplier es = suppliers.get(supplier);
        changedsupplier.put(supplier, new EnergySupplier(es.getClients(), es.getInvoices(), baseRate, es.getTax()));
    }
